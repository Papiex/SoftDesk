    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('BACK_END', 'Back-end'), ('FRONT_END', 'Front-end'), ('ANDROID', 'Android'), ('IOS', 'iOS')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission', models.CharField(choices=[('AUTHOR', 'Author'), ('MANAGER', 'Manager'), ('CREATOR', 'Creator')], max_length=16)),
                ('role', models.CharField(choices=[('READ', 'Read'), ('ALL', 'All')], max_length=16)),
